...
public:
    ...
    bool test(char *cfgfile, char *weightfile, char *filename, float thresh);
...
private:
    ...
    void draw_detections_v3(ImageUtil::ImageData im, detection *dets, int num, float thresh, char** names, ImageUtil::ImageData **alphabet, int classes, int ext_output);
